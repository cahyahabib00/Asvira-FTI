...
sudo sed -i "s/APP_URL=http:\/\/localhost/APP_URL=https:\/\/103.82.93.100/" .env
...
echo "=========================="
echo "URL: http://103.82.93.100"
echo "Chatbot: http://103.82.93.100/chatbot"
echo "Admin: http://103.82.93.100/login"
echo ""
